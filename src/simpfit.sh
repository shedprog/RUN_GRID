...
function shape {
    ...
    do
        ...
        echo $(grep -i "^$CItype\b" $WORKDIR/$1)
		...
		do
            ...
            sed "s|REFWORKDIR|$WORKDIR|g ; s|REFOUTDIR|$OUTPUTDIR|g ;\
                ...
                s|INCISimpFitStep=.*|INCISimpFitStep='SimpFit'|g;\
                s|INchange_CIvarval_afterMC=.*|INchange_CIvarval_afterMC=false|g\
                " $WORKDIR/tmp_grid/batch_bird_sf.cmd > $OUTPUTDIR/RUN/run_sf/batch_SM_${CItype}_${IREP}.cmd

            condor_qsub -l distro=sld6 -l h_vmem=5000M -q short.q -cwd $OUTPUTDIR/RUN/run_sf/batch_SM_${CItype}_${IREP}.cmd &
